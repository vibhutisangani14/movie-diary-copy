(()=>{function e(e,t,r,o){Object.defineProperty(e,t,{get:r,set:o,enumerable:!0,configurable:!0})}var t=globalThis,r={},o={},s=t.parcelRequire8370;null==s&&((s=function(e){if(e in r)return r[e].exports;if(e in o){var t=o[e];delete o[e];var s={id:e,exports:{}};return r[e]=s,t.call(s.exports,s,s.exports),s.exports}var i=Error("Cannot find module '"+e+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(e,t){o[e]=t},t.parcelRequire8370=s);var i=s.register;i("3UQcn",function(e,t){var r=s("9CpIJ"),o=s("25ITN");let i=document.querySelector("#movieList-journal");(0,r.searchEventListners)(),(0,r.renderSearchList)();let l=JSON.parse(localStorage.getItem("favouriteMovie"))||[];i.innerHTML="",l.forEach(e=>{var t;let r=e.overview.length>100?e.overview.slice(0,100)+"...":e.overview,s=document.createElement("div");s.className="max-auto text-white rounded-lg shadow-md",s.innerHTML=`
    ...
    `,i.appendChild(s),(0,o.toggleOverviewText)(s),t=e,s.querySelector("#notes-icon").addEventListener("click",()=>{let e=document.querySelector("#dialogOverlay"),r=document.querySelector("#noteText"),o=document.querySelector("#saveBtn"),s=document.querySelector("#closeBtn"),i="Notes",l=JSON.parse(localStorage.getItem(i))||[],n=l.find(e=>e.id===t.id);console.log(l[0].id+" "+t.id),r.value=n?n.content:"",e.classList.remove("hidden"),o.onclick=()=>{let o=l.filter(e=>e.id!==t.id);r.value.trim()&&o.push({id:t.id,content:r.value.trim()}),localStorage.setItem(i,JSON.stringify(o)),e.classList.add("hidden")},s.onclick=()=>e.classList.add("hidden"),e.onclick=t=>{t.target===e&&e.classList.add("hidden")}})})}),i("9CpIJ",function(t,r){e(t.exports,"searchEventListners",()=>l),e(t.exports,"renderSearchList",()=>n);let o=document.getElementById("searchBtn"),s=document.getElementById("searchInput"),i=document.getElementById("suggestions"),l=()=>{o.addEventListener("click",e=>{e.stopPropagation(),s.classList.remove("w-0","opacity-0","mx-0"),s.classList.add("w-64","opacity-100","mx-2"),s.focus()}),document.addEventListener("click",e=>{searchWrapper.contains(e.target)||(s.classList.remove("w-64","opacity-100","mx-2"),s.classList.add("w-0","opacity-0","mx-0"),s.blur())})},n=()=>{let e=async e=>{let t=await fetch(`https://api.themoviedb.org/3/search/movie?query=${e}&
    include_adult=false&language=en-US&page=1&api_key=db85a489a7f0131f0f43f57e6a905f19`);if(!t.ok)throw Error(`HTTP error! status: ${t.status}`);return(await t.json()).results},t=async t=>{try{let r=await e(t);console.log("Fetched movies:",r);let o=r.filter(e=>e.title.toLowerCase().includes(t));o.forEach(e=>{let t=document.createElement("div");t.className="flex flex-row px-3 py-2 hover:bg-gray-700 cursor-pointer",t.innerHTML=`
     <img
                  ...
                  </div>`,t.addEventListener("click",()=>{s.value=e.title,i.classList.add("hidden")}),i.appendChild(t),i.classList.toggle("hidden",0===o.length)})}catch(e){console.error("Error fetching movie list:",e);return}};s.addEventListener("input",()=>{let e=s.value.toLowerCase();i.innerHTML="",e?t(e):i.classList.add("hidden")}),document.addEventListener("click",e=>{e.target.closest("#searchBox")||e.target.closest("#suggestions")||i.classList.add("hidden")})}}),i("25ITN",function(t,r){e(t.exports,"toggleOverviewText",()=>n);var o=s("9CpIJ");let i=document.querySelector("#movieList-container");(0,o.searchEventListners)(),(0,o.renderSearchList)();let l=async()=>{let e=await fetch("https://api.themoviedb.org/3/movie/popular?language=en-US&page=1&api_key=db85a489a7f0131f0f43f57e6a905f19");if(!e.ok)throw Error(`HTTP error! status: ${e.status}`);return(await e.json()).results},n=e=>{let t=e.querySelector(".toggle-btn"),r=e.querySelector(".short-text"),o=e.querySelector(".full-text");t.addEventListener("click",()=>{o.classList.contains("hidden")?(r.classList.add("hidden"),o.classList.remove("hidden"),t.textContent="Read less"):(r.classList.remove("hidden"),o.classList.add("hidden"),t.textContent="Read more")})};(async()=>{try{let e=await l();console.log("Fetched movies:",e),e.forEach(e=>{var t;let r=document.createElement("div");r.className="max-auto  text-white rounded-lg shadow-md";let o=(JSON.parse(localStorage.getItem("favouriteMovie"))||[]).some(t=>t.id===e.id),s=e.overview.length>100?e.overview.slice(0,100)+"...":e.overview;r.innerHTML=`
      <img src="https://image.tmdb.org/t/p/w500${e.poster_path}" alt="${e.title} poster" 
        class="border-gray-800 rounded-lg border-4 hover:border-white
        transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-lg mb-2"/>
      <div class="p-2 flex justify-between">
